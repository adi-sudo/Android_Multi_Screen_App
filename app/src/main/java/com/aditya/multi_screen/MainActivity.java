package com.aditya.multi_screen;
...
public class MainActivity extends AppCompatActivity {
    ...
    public static final String MSG= "com.aditya.myapplication.multi_screen.ORDER";
    ...
    public void placeOrder(View view)   {
        ...
        String message= "Order for " + editText1.getText().toString() + " , "
                        ...
                        + editText3.getText().toString() + " has been succesfully placed.";
